...
if (isset($_POST['enregistrer'])) {
    ...
    if (!empty($nom) && !empty($utilisateur) && !empty($motdepasse)) {
        $insert = $con->prepare("INSERT INTO usercompte(id, nomUtilisateur, motdepasse) VALUES(:nom, :utilisateur, :motdepasse)");
...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/@yaireo/tagify@3.22.1/dist/tagify.css">
...
<body>
        ...
        <div class="up">
            ...
            <div class="popup-input">
                <form action="update_employee.php" class="form" method ="post">
                    <input type="hidden" name="idcompte" value="<?php echo $compteId; ?>">
                    <div class="form-divi">
                        <div class="form-div">
                            <select class name="nom">
                    ...
                    <button class="form-btn" name="modf">Enregistrer</button>
                </form>
            </div>
        </div>
   ...
   <div class="navigation">
        ...
        <ul class="dec">
            <div class="divCompte">
                <a href="admin.php" class="vue"><i class="ri-admin-line"></i>Admin</a></l>
                <a href="compte.php" class="vue acti"><i class="ri-user-line"></i></i>Utilisateur</a></l>
            </div>
   ...
   <div class="content">
        ...
        <div class="main">
            ...
            <!-- <div class="details"> -->
                <div class="recent">
                    <div class="header">
                        <h3>Gérer compte utilisateur</h3>
                        <div class="">
                    ...
                    <table>
                        ...
                        <tbody>
                        <?php
                            $sql = "SELECT r.idCompte, p.nom, r.nomUtilisateur, r.motdepasse FROM usercompte r join employe p on (p.id = r.id)";
                            try {
                                $stmt = $con->query($sql);
                                
                                while ($row = $stmt->fetch()) {
                                    echo "
                                        <tr data-id='" . $row['idCompte'] . "'>
                                            <td>" . $row['nom'] . "</td>
                                            <td>" . $row['nomUtilisateur'] . "</td>
                                            <td>" . $row['motdepasse'] . "</td>
                                            <td><i class='ri-mail-send-fill envoye tooltip' data-title='Envoyer à " . $row['nom'] . "'></i></td>
                                        </tr>
                                    ";
                                }
    ...
    <!-- <script>
        document.addEventListener('click', function (e) {
            if (e.target.classList.contains('envoye')) {
                // Récupérer l'ID de l'employé associé à la ligne
                var employeId = e.target.closest('tr').getAttribute('data-id');

                // Envoyer une requête AJAX pour déclencher l'envoi de l'e-mail
...
<script>
    document.addEventListener('click', function (e) {
        if (e.target.classList.contains('envoye')) {
            ...
            xhr.send('employeId=' + employeId);
                ...
                // Clic en dehors de la modal, masquer la modal
                hideProgressModal();
        }
    });
    ...
    <!--fin evoye email et Progress bar -->
        ...
        const navi = document.querySelectorAll('.navigation .menu li a:not(.deconnect)');
            ...
            $(document).ready(function(){
                ...
                $(".sup").click(function () {
                    ...
                    var compteId = selectedRow.data("id");
                ...
                $(".mod").click(function () {
                    ...
                    if (compteId) {
                        ...
                        $(".popup1 input[name='idcompte']").val(compteId);
