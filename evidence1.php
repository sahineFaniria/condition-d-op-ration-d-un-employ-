...
<body>
   ...
   <div class="navigation">
        ...
        <ul class="menu">
            ...
            <li class="active"><a href="#"><i class="ri-folder-chart-2-fill"></i>Evidence</a></li>
        </ul>
   ...
   <div class="content">
        ...
        <div class="main">
            ...
            <?php
                // Récupérez les données depuis la base de données en utilisant une jointure
                include("connection.php");

                $query = $con->prepare("SELECT e.idEvidence, e.type, emp.nom, emp.role, c.evidence
                                    FROM evidence e
                                    JOIN travail c ON e.id = c.id
                                    JOIN employe emp ON e.id = emp.id");
                $query->execute();
                ...
                <div class="content-box">
                    <?php foreach ($donnees as $row) : ?>
                        <div class="box">
                                ...
                                <img src="image/<?= $row['type'] ?>" alt="">
                                <div class="box-evi">
                                    <h3><?php echo $row['nom']; ?></h3>
                                    <p>ROLE : <?php echo $row['role']; ?></p>
                                    <p>Evidence : <?php echo $row['evidence']; ?></p>
                                </div>

                                <a href="delete_employee.php?id=<?= $row['idEvidence'] ?>" class="del">
